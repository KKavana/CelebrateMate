// src/components/AddReminder.jsx

import React, { useState } from "react";
import { addReminder } from "../utils/api"; // Assuming you implement this in api.js
import "../styles/AddReminder.css";

const AddReminder = ({ onAddReminder }) => {
  // Pass onAddReminder as a prop
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const newReminder = await addReminder(reminderData); // Get the added reminder from API
      onAddReminder(newReminder); // Call the function passed as a prop to update the Dashboard state
